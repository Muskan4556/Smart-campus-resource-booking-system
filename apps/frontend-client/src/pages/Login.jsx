    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .login-form-title {
          font-family: var(--font-s); font-size: clamp(30px, 3vw, 42px);
        ...
        .login-field-input.err:focus { box-shadow: 0 0 0 3px rgba(192,57,43,0.08); }
        ...
        .login-btn-submit {
          ...
          font-family: var(--font-b); font-size: 14px; font-weight: 600; letter-spacing: 0.05em;
      ...
      <div className="login-page">
        ...
        <div className="login-brand">
          ...
          <div className="login-features">
            {["Book labs, rooms & sports courts", "Real-time availability", "Instant email confirmation"].map(f => (
