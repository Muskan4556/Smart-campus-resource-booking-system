    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .su-brand-title {
          font-family: var(--su-font-s); font-size: clamp(34px, 3.2vw, 48px);
        ...
        .su-form-panel::before {
          ...
          background-image:
            linear-gradient(var(--su-border) 1px, transparent 1px),
            linear-gradient(90deg, var(--su-border) 1px, transparent 1px);
        ...
        .su-form-box {
          ...
          animation: suFadeUp 0.6s ease both;
        }
        ...
        .su-form-title {
          font-family: var(--su-font-s); font-size: clamp(28px, 3vw, 40px);
          line-height: 1.05; color: var(--su-ink); margin-bottom: 8px;
        }
        ...
        .su-field-label {
          ...
          color: var(--su-ink2); margin-bottom: 8px;
        }
        .su-field-input {
          width: 100%; padding: 12px 16px;
          font-family: var(--su-font-b); font-size: 14px; color: var(--su-ink);
          background: var(--su-bg); border: 1.5px solid var(--su-border);
          border-radius: 2px; outline: none;
          transition: border-color 0.2s, background 0.2s, box-shadow 0.2s;
        }
        .su-field-input::placeholder { color: var(--su-muted); }
        .su-field-input:focus {
          border-color: var(--su-navy); background: var(--su-surface);
          box-shadow: 0 0 0 3px rgba(15,31,92,0.08);
        }
        .su-field-input.su-err { border-color: var(--su-error); }
        .su-field-input.su-err:focus { box-shadow: 0 0 0 3px rgba(192,57,43,0.08); }

        /* Password strength */
        .su-strength-bar-wrap {
          height: 3px; background: var(--su-border); border-radius: 999px;
        ...
        .su-rule {
          ...
          font-size: 12px; color: var(--su-muted); transition: color 0.2s;
        }
        .su-rule.su-ok { color: #16a34a; }
        .su-rule-dot {
          width: 5px; height: 5px; border-radius: 50%;
          background: var(--su-border); flex-shrink: 0; transition: background 0.2s;
        }
        ...
        .su-error-box {
          ...
          font-size: 13px; color: var(--su-error);
        ...
        .su-btn-submit {
          ...
          font-family: var(--su-font-b); font-size: 14px; font-weight: 600; letter-spacing: 0.05em;
          color: #fff; background: var(--su-navy);
        ...
        .su-btn-submit:hover:not(:disabled) {
          background: var(--su-navy-dk); transform: translateY(-1px);
          box-shadow: 0 8px 24px rgba(15,31,92,0.28);
        }
        .su-btn-submit:disabled { opacity: 0.55; cursor: not-allowed; }

        .su-divider {
          display: flex; align-items: center; gap: 14px;
          margin: 24px 0; color: var(--su-muted); font-size: 12px;
        }
                ...
                <>
                  <div className="su-strength-bar-wrap">
                    <div
                      ...
                      style={{ width: `${(passStrength / 5) * 100}%`, background: strengthColor }}
                    />
                  </div>
